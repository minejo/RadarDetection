...
function [class,type]=dbscan(x,k,Eps, parameterWeight)
...
for i=1:m
    if touched(i)==0
        ob=x(i,:);
        D=dist(ob(2:n),x(:,2:n),parameterWeight);
        ind=find(D<=Eps);
...
%............................................
function [D]=dist(i,x, parameterWeight)
...
[m,n]=size(x);
D = sqrt((((ones(m,1)*i)-x).^2) * parameterWeight')';

if n==1
    D=abs((ones(m,1)*i-x)* parameterWeight')';
end
