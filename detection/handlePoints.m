function [ objectCell, clusternum ] = handlePoints(points, minPts, distanceLDoor, velocityDoor, type)
...
if type == 1
    ...
    [class, type] = dbscan(points, minPts, sqrt(distanceLDoor^2 + (2 * small_beam)^2 + velocityDoor^2));
end
