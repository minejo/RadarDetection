...
global M N CFAR_N_l CFAR_N_w window_r deltaR deltaV big_beam small_beam
...
for i = 1:M
    for j = 1:N/2
        ...
        hasObject_w = gocfar(referWindow_w, data(i, j));
        %距离维cfar
        referWindow_l = zeros(CFAR_N_l);
