...
function [track_temp1, track_normal, ones_result1] = create_formaltrack(track_temp, track_normal, ones_result, TT, t)
...
for i=1:temp_num
    ...
    for j = 1:scan_num
        if(~isempty(ones_result1))
            ...
            [isTrue, Weightmean] = temptrackfindobject(onetemptrack, one, time_diff,time_diff_min, dis_diff, v_diff, fangwei_diff,TT,t);%该点是否多个条件都符合，如果符合权重加和为多少
